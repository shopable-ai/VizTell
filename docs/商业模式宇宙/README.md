...
| 目录 | 唯一职责 |
|---|---|
| `00_导航与总览` | 当前版本、加载入口、边界、分类规范、使用路径、风险门与验收 |
| `01_核心机制与组合模式` | 当前总览、U01-U27、L2 atoms、L3 patterns、v4 商品角色/价格/Offer 横向系统、主题知识地图 |
...
- **快速理解**：`README → 00/00_当前有效版本与加载入口 → 01/00_商业模式宇宙总览与核心结论 → 06_真实经济性_返点与治理`
